...
const Reviews = () => {
  ...
  const handlePrev = useCallback(() => {
    ...
    const prevIndex =
      activeReview === 0 ? reviews.length - 1 : activeReview - 1;
  ...
  const handleNext = useCallback(() => {
    if (animationInProgressRef.current) return;
    const nextIndex =
      activeReview === reviews.length - 1 ? 0 : activeReview + 1;
  ...
  return (
    <section className="reviews" ref={reviewsContainerRef}>
      <div className="reviews-top-nav">
        <p className="primary sm">Testimonials</p>
      ...
      <div className="reviews-bottom">
        <div className="reviews-thumbnails">
        ...
        <div className="reviews-arrows">
          <button className="review-arrow-btn" onClick={handlePrev} aria-label="Previous review">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path d="M13 16L7 10L13 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </button>
          <button className="review-arrow-btn" onClick={handleNext} aria-label="Next review">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
